...
os.environ['MLFLOW_TRACKING_URI']="https://dagshub.com/akashgaikwad746/Machine_learning_pipeline.mlflow"
...
def train(data_path,model_path,random_state,n_estimators,max_depth):
    ...
    mlflow.set_tracking_uri("https://dagshub.com/akashgaikwad746/Machine_learning_pipeline.mlflow")
    ...
    with mlflow.start_run():
        ...
        # Log model file as artifact (DagsHub-friendly)
        mlflow.log_artifact(model_path, artifact_path="model")

        print(f"Model saved to {model_path} and logged to MLflow artifacts")
